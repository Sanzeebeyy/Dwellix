...
class ShowRoomForSeekerAccepted(BaseModel):
    id:int
    title: str
    description: str
    area: str
...
class ShowGeneralApplications(BaseModel):
    id:int
    room_id:int
    applicant_id: int
    status: ApplicationStatus
...
class RejectedApplications(BaseModel):
    id: int
    room_id: int
    applicant: ShowPublicUser
    bargain_amount: int
...
class ForSeekerRejectedApplications(BaseModel):
    id: int
    room_id: int
    bargain_amount: int
    status:ApplicationStatus
...
class ForSeekerAcceptedApplications(BaseModel):
    id: int
    room_id: int
    bargain_amount: int
    status:ApplicationStatus
